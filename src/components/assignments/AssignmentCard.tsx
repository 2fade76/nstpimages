...
interface AssignmentCardProps {
  ...
  onEdit: (assignment: AssignmentWithPhotographer) => void;
  onDelete: (assignment: AssignmentWithPhotographer) => void;
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-2">
              <div className="flex items-center">
                <span className={`h-3 w-3 rounded-full mr-2 ${statusColors[assignment.status]}`} />
