    ...
    <Card>
      ...
      <CardContent className="pt-0">
        <div className="grid grid-cols-2 gap-4 text-sm">
          ...
          {cameraSet.camera_year_make && (
            <div>
              <span className="font-medium">Camera Make/Year:</span> {cameraSet.camera_year_make}
            </div>
          )}
          {cameraSet.lens_16_35_serial && (
            <div>
          ...
          {cameraSet.adapter_serial && (
            <div>
              <span className="font-medium">Adapter:</span> {cameraSet.adapter_serial}
            </div>
          )}
        </div>
        {cameraSet.notes && (
