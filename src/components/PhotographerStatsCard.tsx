...
export function PhotographerStatsCard({
  photographers
}: PhotographerStatsCardProps) {
  ...
  return <div className="grid gap-4 md:grid-cols-3 mb-6">
      ...
      return <Card key={stat.title}>
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2 bg-blue-800">
            ...
            <CardContent>
              ...
              <p className="text-xs text-muted-foreground py-[3px]">
                {stat.description}
              </p>
            </CardContent>
          </Card>;
