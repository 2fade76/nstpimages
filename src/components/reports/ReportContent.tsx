            ...
            <TableBody>
              {reportData.cameraSets.map((cameraSet) => (
                <TableRow key={cameraSet.id}>
                  <TableCell className="font-medium">{cameraSet.camera_body_model}</TableCell>
                  <TableCell>{cameraSet.camera_body_serial}</TableCell>
                  <TableCell>{cameraSet.photographer_name}</TableCell>
                  <TableCell>
